...
const inventorBirth = inventors.sort((a, b) => {
...
//get all links with a class of mwcategory
/*const category = document.querySelector(".mw-category");

//store links in an array
const links = Array.from(category.querySelectorAll("a"));

//check for links with de and store in a new array
const containsDE = links
  .map((link) => link.textContent)
  .filter((streetName) => streetName.includes("de"));
  */

const inventorsLastName = inventors.map((inventor) => inventor.last);
inventorsLastName.sort();
